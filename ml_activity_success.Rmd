...
row.names(pred.acc) <- c("SVM.Radial", "RandomForest", "GradientBoost", "Stack")
...
Although the ensemble model performs better overall, it's performance by class variable is better as well. Look at the performance by class below:
